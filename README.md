...
- <span style="color:red">IMPORTANTE: El BUZZER NO PUEDE ESTAR SOLDADO A LA MISMA PLACA DEL ACELERÓMETRO, causa falsas Salidas, ya que la vibración activa el sensor* text</span>
